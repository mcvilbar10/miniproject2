...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relatve'>
      <NavButton title="Menu" customjFunc={handleActiveMenu}
        color="blue" icon={<AiOutlineMenu />}
      />
      <div className='flex'>
      <NavButton 
        title="Cart" 
        customjFunc={()=>handleClick('cart')}
        color="blue" 
        icon={<FiShoppingCart />}
      />
      <NavButton 
        title="Chat"
        dotColor="#03C907"
        customjFunc={()=>handleClick('chat')}
        color="blue" 
        icon={<BsChatLeft />}
      />
      <NavButton 
        title="Notifications" 
        customjFunc={()=>handleClick('notification')}
        color="blue" 
      ...
      >
        ...
        >
          ...
          <p><span className='text-gray-400 text-14'>Hi,</span> <span className='text-gray-400 font-bold ml-1 text-14'>Michael</span>
          </p>
